...
import { createUser, getUsers, getDashboardInfo, archiveUser, unarchiveUser, getUserById, editUser, resetUserPassword } from "../controllers/adminController.js";
...
router.patch("/reset-user-password/:id", 
  authenticateJWT,
  authorizeAdmin,
  resetUserPassword
);
