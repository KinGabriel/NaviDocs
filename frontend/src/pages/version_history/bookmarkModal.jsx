...
export default function BookmarkModal({ show, onClose, bookmarkName, setBookmarkName, onConfirm }) {
  ...
  return (
    ...
    <div 
      onClick={onClose} 
      className="fixed inset-0 backdrop-blur-[2px] bg-black/40 flex items-center justify-center z-50 p-4"
    >
      <div 
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Bookmark Version</h1>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-6 space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder:text-gray-400"
