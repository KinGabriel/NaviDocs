...
export default function ArchivedDocuments() {
  ...
  const confirmUnarchive = async () => {
    ...
    setRowBusy(selectedDoc._id || selectedDoc.id);
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col">
        ...
        >
          <div className="flex-1 px-0 lg:px-1 py-5">
            ...
            <div className="flex items-center gap-3 mt-3">
              <button
                ...
                onClick={() => {
                  if (window.history.length > 1) {
                    ...
                    navigate("/documents"); // fallback route
                  }
                }}
                onKeyDown={(e) => {
              ...
              <h1 className="text-2xl lg:text-3xl font-bold text-black-800 tracking-widest uppercase mt-1">
                ARCHIVES
              </h1>
            </div>
      ...
      <UnarchiveDocumentModal
        open={openUnarchive}
        onClose={() => !modalSubmitting && setOpenUnarchive(false)}
      ...
      <PermanentlyDeleteDocumentModal
        ...
        onClose={() => !modalSubmitting && setOpenPermanentDelete(false)}
