...
export default function DeanDashboard() {
  ...
  const chartData = {
    labels: ["Submission Rate", "Approved Documents", "Assigned Documents", "Pending Documents", "Returned Documents"],
    datasets: [
      {
        data: [56, 36, 5, 7, 15, 5],
        ...
        <main className="flex-1 flex flex-col bg-white shadow pt-1 pb-4 px-8 mx-6 mt-8 rounded-xl ">
                ...
                <div className="w-12 h-12 bg-[#003DA5] rounded-full flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" viewBox="0 0 24 24">
                    <g fill="none">
                      ...
                      <path fill="#fff" d="M12 3a3 3 0 0 0-1 5.83V11H8a3 3 0 0 0-3 3v1.17a3.001 3.001 0 1 0 2 0V14a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v1.17a3.001 3.001 0 1 0 2 0V14a3 3 0 0 0-3-3h-3V8.83A3.001 3.001 0 0 0 12 3" />
                    </g>
                  </svg>
                </div>
                <div>
          ...
          <div className="grid grid-cols-4 gap-6 flex-1">
            <div className="col-span-3 space-y-6">
              ...
              <div className="bg-[#FBFBFB] shadow p-4 rounded max-w-6xl w-full">
                <div className="px-3 py-1 bg-gray-50 flex justify-between items-center rounded-lg">
                  ...
                  <button
                    onClick={() => navigate("/documents", { state: { status: "Pending Approval" } })}
                    className="mr-4 mb-2 bg-[#003DA5] text-white text-sm px-4 py-1 rounded-md hover:bg-[#002B7F]"
                  >
                    View All
                  </button>
            ...
            <div className="col-span-1 space-y-6">
              ...
              {/* Documents Summary Doughnut Chart */}
