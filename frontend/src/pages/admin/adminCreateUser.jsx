                  ...
                  */}
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 mt-4">
                    <button
                      type="button"
                      onClick={handleClear}
                      className="px-6 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 w-full sm:w-auto"
                    >
                      Clear
                    </button>
                    <button
                      type="submit"
                      className="px-6 py-2 bg-blue-700 text-white rounded-md hover:bg-blue-800 disabled:opacity-50 w-full sm:w-auto"
