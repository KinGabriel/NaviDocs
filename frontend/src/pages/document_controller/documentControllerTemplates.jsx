...
export default function DocumentControllerTemplates() {
  ...
  const handleCreateTemplate = () => {
    navigate('/document-controller/create-template');
  };
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex-1 flex justify-end">
                <button 
                  ...
                  className="flex items-center gap-2 bg-[#0035DA] hover:bg-[#043485] text-white font-semibold px-5 py-2 rounded shadow"
                >
