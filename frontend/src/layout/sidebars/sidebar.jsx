...
export default function Sidebar({ user }) {
  ...
  // NEW: responsive open/close state (open on desktop, closed on mobile)
  const [isOpen, setIsOpen] = useState(() => (typeof window !== 'undefined' ? window.innerWidth >= 1024 : true));

  // NEW: keep state in sync with viewport size
  useEffect(() => {
    const onResize = () => {
  ...
  // NEW: close drawer on route change for mobile
  useEffect(() => {
    if (typeof window !== 'undefined' && window.innerWidth < 1024) setIsOpen(false);
  }, [location.pathname]);

  // NEW: allow ESC to close on mobile
  useEffect(() => {
    const onKey = (e) => {
  ...
  return (
    <>
      {/* NEW: Hamburger button (shown on small screens only) */}
      <button
        type="button"
        aria-label="Open menu"
        aria-expanded={isOpen}
        onClick={() => setIsOpen(true)}
        className="lg:hidden fixed top-4 left-4 z-[70] inline-flex items-center justify-center p-2 rounded-md border border-gray-200 bg-white shadow"
      >
      ...
      {/* Sidebar (becomes off-canvas on mobile, unchanged layout on desktop) */}
      <div
        className={[
          "bg-white shadow pt-8 pb-4 px-8 w-80 flex flex-col items-center min-h-[70vh] relative mx-6 mt-8 rounded-xl",
          // NEW: off-canvas behavior on mobile/tablet, static on lg+
          "transition-transform duration-300 ease-out",
          "fixed top-0 left-0 h-full z-[70] lg:static lg:h-auto",
          isOpen ? "translate-x-0" : "-translate-x-full",
          "lg:translate-x-0",
        ].join(" ")}
        role="dialog"
        aria-modal={typeof window !== 'undefined' && window.innerWidth < 1024 ? "true" : "false"}
      ...
      >
        ...
        <button
          ...
          className="lg:hidden absolute top-3 right-3 p-2 rounded-md hover:bg-gray-100"
        >
  ...
  Faculty: [
    {
      label: "Dashboard",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 15 15"><path fill="#003DA5" fillRule="evenodd" d="M2.8 1h-.05c-.229 0-.426 0-.6.041A1.5 1.5 0 0 0 1.04 2.15c-.04.174-.04.37-.04.6v2.5c0 .229 0 .426.041 .6A1.5 1.5 0 0 0 2.15 6.96c.174 .04 .37 .04 .6 .04h2.5c.229 0 .426 0 .6 -.041A1.5 1.5 0 0 0 6.96 5.85c.04 -.174 .04 -.37 .04 -.6v-2.5c0 -.229 0 -.426 -.041 -.6A1.5 1.5 0 0 0 5.85 1.04C5.676 1 5.48 1 5.25 1z" />
        </svg>
      ),
    ...
    },
    {
      label: "Documents",
      icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 48 48"><path fill="none" stroke="#0035da" strokeLinecap="round" strokeLinejoin="round" d="M10.364 4.51a1.994 1.994 0 0 0-1.945 1.994v35.002a1.995 1.995 0 0 0 1.944 1.994h27.224a1.994 1.994 0 0 0 1.994-1.994V14.472h-7.977a1.995 1.995 0 0 1-1.945-1.995V4.5Zm19.205 0l9.962 9.962m-23.693 8.456h16.274M15.838 34.994h16.274m-16.274-6.033h16.274" strokeWidth="2"/>
       </svg>
      ),
      route: "/documents"
    },
  ...
  "Document Controller": [
    {
      label: "Dashboard",
      icon: (
         <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 15 15"><path fill="#003DA5" fillRule="evenodd" d="M2.8 1h-.05c-.229 0-.426 0-.6 .041A1.5 1.5 0 0 0 1.04 2.15c-.04 .174 -.04 .37 -.04 .6v2.5c0 .229 0 .426 .041 .6A1.5 1.5 0 0 0 2.15 6.96c.174 .04 .37 .04 .6 .04h2.5c.229 0 .426 0 .6 -.041A1.5 1.5 0 0 0 6.96 5.85c.04 -.174 .04 -.37 .04 -.6v-2.5c0 -.229 0 -.426 -.041 -.6A1.5 1.5 0 0 0 5.85 1.04z" />
        </svg>
      ),
