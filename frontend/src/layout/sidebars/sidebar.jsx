...
const MENU_CONFIG = {
  ...
  Admin: [
    ...
    },
    {
      ...
      icon: (
 <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" fill="#003DA5">
      <path d="M12 1a11 11 0 1 0 11 11A11.013 11.013 0 0 0 12 1zm0 20a9 9 0 1 1 9-9 9.01 9.01 0 0 1-9 9zm.5-9.5V6h-1v6l5.25 3.15.5-.86L12.5 11.5z"/>
    </svg>
      ),
  ...
  Faculty: [
    ...
    { 
      ...
      route: "/faculty/document-workflow"
    },
    { 
      label: "Storage",
      icon: (
  ...
  /* Lead Document Controller Module */
  ...
  /* Document Control Officer Module */
  ...
  /* Unit Document Controller Module */
