      ...
      >
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 bg-gray-50 rounded-b-2xl">
          ...
          <button
            onClick={onConfirm}
            disabled={submitting}
            className="px-5 py-2.5 rounded-lg font-medium bg-red-600 text-white hover:bg-red-700 active:bg-red-800 transition-colors disabled:opacity-50 shadow-sm hover:shadow flex items-center gap-2"
          >
            {submitting ? (
              <>
